...
area  DECIMAL(19,2),
property_type_id INT FOREIGN KEY REFERENCES property_types(id),
...
(
id INT FOREIGN KEY REFERENCES properties (id) NOT NULL,
agent_id INT FOREIGN KEY REFERENCES agents (id) NOT NULL,
price DECIMAL(19,2) NOT NULL,
...
(
id INT PRIMARY KEY,
property_id INT FOREIGN KEY REFERENCES properties(Id) NOT NULL, 
buyer_id INT FOREIGN KEY REFERENCES buyers(id) NOT NULL,
...
values (1, '10 Downing Street', 1000000.00, 2000, 1, 1),
       ...
       (9, '4 Avenue des Champs-Élysées', 850000.00, 105.8, 2, 2),
       (10, 'Rue de la Paix 7', 650000.00, 92, 3, 2),
       (11, '16 Place Vendôme', 1200000.00, 150.2, 4, 2),
       (12, '2 Rue du Faubourg Saint-Honoré', 980000.00, 120.75, 5, 2),
       (13, 'Rue de Varenne', 720000.00, 88.3, 6, 2),
       (14, '9 Rue de Sèvres', 580000.00, 80.6, 7, 2),
       (15, 'Alexanderplatz 1, 10178', 250000.00, 1000, 1, 3),
       (16, 'Unter den Linden 16, 10117', 150000.00, 800, 2, 3),
       (17, 'Friedrichstraße 180, 10117', 300000.00, 1200, 3, 3),
       (18, 'Potsdamer Platz 1, 10785', 350000.00, 1500, 4, 3),
       (19, 'Kurfürstendamm 200, 10719', 200000.00, 900, 5, 3),
       (20, 'Schlossstraße 1, 12163', 400000.00, 1000, 6, 3),
       ...
       (42, 'Schönbrunner Schlossstrasse 7', 1000000.00, 200, 7, 6),
...
values (1, 'Giuseppe', 'Rossi', '123-456-7890', 'giuseppe@example.com', 1),
       (2, 'Sophie', 'Lefèvre', '234-567-8901', 'sophie@example.com', 2),
       (3, 'Lukas', 'Müller', '345-678-975', 'lukas@example.com', 3),
       ...
       (13, 'Max', 'Müller', '345-68-9012', 'max@example.com', 3),
       ...
       (17, 'Chloé', 'Dubois', '789-012-3416', 'chloe@example.com', 7),
       ...
       (21, 'Léa', 'Dupont', '234-567-8935', 'lea@example.com', 2),
       (22, 'Paul', 'Müller', '345-678-9612', 'paul@example.com', 3),
       ...
       (26, 'Amélie', 'Weber', '789-012-3456', 'amelie@example.com', 7),
